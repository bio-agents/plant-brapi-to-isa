...
from isaagents.model import Investigation, OntologyAnnotation, OntologySource, Assay, Study, Characteristic, Source, \
...
isaagents.isatab.dump(investigation, output_path=directory)  # dumps() writes out the ISA
# as a string representation of the ISA-Tab
# isaagents.isatab.dumps(investigation)
# isaagents.isatab.dump(isa_obj=investigation, output_path='./out/')
...
#         os.makedirs(directory)
#     isaagents.isatab.dump(investigation, directory)
#
